# Questões de SQL — Sistema de Gestão de Transportadora TransLógica

> Banco: **TransportadoraTransLogica** (SQL Server / T-SQL)
>
...
1. Liste as cidades que possuem filiais cadastradas e o número de veículos vinculados a viagens com origem nessas filiais, exibindo apenas as cidades que possuem mais de 2 veículos distintos associados.
